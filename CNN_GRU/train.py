...
### Load Data
train_set, valid_set, dicts = pickle.load(open('dataset/atis.pkl', 'rb'))
...
for i in range(n_epochs):
    ...
    if con_dict['f1'] > best_val_f1:
    	...
    	open('/output/model_architecture.json','w').write(model.to_json())
    	model.save_weights('/output/best_model_weights.h5',overwrite=True)
